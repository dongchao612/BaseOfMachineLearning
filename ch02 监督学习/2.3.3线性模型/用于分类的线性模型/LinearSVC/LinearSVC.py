...
if __name__ == '__main__':
    ...
    print("test set predictions: {}".format(svc.predict(X_test)))  # test set predictions: [1 1 0 0 0 1 0]
    print("test set accuracy: {:.2f}".format(svc.score(X_test, y_test)))  # test set accuracy: 0.86
